...
_initial_activities = {
    ...
    "Soccer Team": {
        "description": "Team practices, scrimmages, and interschool matches",
    ...
    "Debate Team": {
        "description": "Practice public speaking, critical thinking, and competitive debates",
...
# For testing: a function to reset activities
...
# Unregister endpoint (needed for tests and frontend)
